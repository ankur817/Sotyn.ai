...
export const CHECKLISTS = {
  "purchase-approval-checklist": {
    ...
    title: "Construction Purchase Approval Checklist (India) — 18 checks | sotyn.ai",
    description:
      "An 18-point checklist for approving construction purchases: what an indent must carry, when to compare rates, who approves at which value, and what to check before the bill is paid. Free to read and download, no sign-up.",
  ...
  "subcontractor-bill-verification-checklist": {
    ...
    title: "Subcontractor Bill Verification Checklist (India) — 18 checks | sotyn.ai",
    description:
      "An 18-point checklist for checking a subcontractor's bill before you certify it: measurement basis, agreed rates, recoveries, retention, TDS and the certification trail. Free to read and download, no sign-up.",
  ...
  "erp-migration-checklist": {
    ...
    title: "Construction ERP Migration Checklist — moving off Excel | sotyn.ai",
    description:
      "A 20-point checklist for moving a contracting business onto an ERP: which masters to clean first, how to bring live projects and opening balances across, what to train by role, and what 'go-live' must mean in writing. Free, no sign-up.",
