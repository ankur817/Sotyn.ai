...
export const calculators: Calc[] = [
  {
    ...
    seoTitle: "Quote Margin Calculator for Contractors | sotyn.ai",
    seoDescription: "Free quote margin calculator for Indian contractors. Enter cost, overhead and target margin to get the price you must quote. No sign-up.",
  ...
  },
  {
    ...
    seoTitle: "Construction Profit Leak Calculator | sotyn.ai",
    seoDescription: "Free calculator to estimate profit leakage for Indian EPC firms. See what 2–3% leakage across quoting, material, labour and billing costs you.",
  ...
  },
  {
    ...
    seoTitle: "Cash-Stuck Calculator for Contractors | sotyn.ai",
  ...
  },
  {
    ...
    seoTitle: "Material Wastage Calculator — BOQ | sotyn.ai India",
    seoDescription: "Free material wastage calculator for Indian contractors. Estimate what over-consumption and leakage against your BOQ costs per year.",
  ...
  },
  {
    ...
    seoTitle: "Labour Leak Calculator for Contractors | sotyn.ai",
    seoDescription: "Free labour leakage calculator for Indian contractors. Estimate the cost of ghost labour and inflated sub-contractor bills. No sign-up.",
  ...
  },
  {
    ...
    seoTitle: "Project Delay Cost Calculator | sotyn.ai India",
  ...
  },
  {
    ...
    seoDescription: "Free retention money calculator for Indian contractors. See how much is held as retention and what that locked cash costs you until release.",
  ...
  },
  {
    ...
    seoTitle: "RA Bill Calculator — Net Payable | sotyn.ai India",
  ...
  },
  {
    ...
    seoTitle: "Construction Software ROI Calculator | sotyn.ai India",
    seoDescription: "Free ROI calculator: see what recovering part of your profit leak is worth, and how fast sotyn.ai pays for itself. For Indian EPC firms.",
